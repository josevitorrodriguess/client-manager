...
func (q *Queries) CountServicesByCustomerID(ctx context.Context, customerID pgtype.UUID) (int64, error) {
...
func (q *Queries) GetServicesByCustomerID(ctx context.Context, customerID pgtype.UUID) ([]Service, error) {
