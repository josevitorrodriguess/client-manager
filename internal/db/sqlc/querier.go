...
type Querier interface {
	...
	CountServicesByCustomerID(ctx context.Context, customerID pgtype.UUID) (int64, error)
	...
	GetServicesByCustomerID(ctx context.Context, customerID pgtype.UUID) ([]Service, error)
